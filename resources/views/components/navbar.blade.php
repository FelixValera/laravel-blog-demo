<nav class="bg-white border-gray-200 dark:bg-gray-900">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <a href="#" class="flex items-center space-x-3 rtl:space-x-reverse">
            <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Blog de Félix</span>
        </a>
        ...
        <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-search">
            ...
            <ul
                ...
                <li>
                    <a href="#"
                        class="{{ request()->is('/') ? 'text-blue-700' : 'text-gray-700' }} block py-2 pr-4 pl-3 md:p-0">Inicio</a>
                </li>
                <li>
                    <a href="#"
                        class="{{ request()->is('posts/*') ? 'text-blue-700' : 'text-gray-700' }} block py-2 pr-4 pl-3 md:p-0">Posts</a>
                </li>
                <li>
                    <a href="#"
